...
if __name__ == "__main__":
    test_event = {
  "date": "27 AUG 2025",
  "tfno": "TF2519523947-02",
  "header": "COVERING SCHEDULE",
  "tnr1": "TENOR & MATURITY DATE: ",
  "tnr2": "SIGHT",
  "tnr3": "",
  "addrs": ["DOCUMENT SENT TO:", "BURGAN BANK,", "HEAD OFFICE, BURGAN TOWER, AL SHARQ,", "P.O. BOX 5389, SAFAT, 12170, KUWAIT"],
  "issuingbank": ["L/C ISSUING BANK", "BURGAN BANK K.S.C, KUWAIT", "", ""],
  "paymentinstruction1": "I.IN REIMBURSEMENT, PLEASE ARRANGE TO REMIT THE PROCEEDS PLUS CHARGES (IF ANY) TO THE CREDIT OF OUR (USD) ACCOUNT NO. 400758954  HELD WITH  CORRESPONDENT BANK CHASUS33 UNDER SWIFT ADVICE TO US.",
  "paymentinstruction2": "II. PLEASE QUOTE OUR REFERENCE IN ALL YOUR CORRESPONDENCE WITH US.",
  "issingbankref": ["L/C ISSUING BANK REF (L/C) NO", "25FS0567/6035412", "", ""],
  "tenordata1": ["TENOR & MATURITY DATE: ", "SIGHT", "", ""],
  "tenordata2": ["BILL AMOUNT", "OUR CHARGES", "OTHER BANK CHARGES", "TOTAL AMOUNT"],
  "tenordata3": ["USD        9,516.00", "BHD           0.000", "USD            0.00", "USD        9,516.00"],
  "encloseddoc1": ["DOCUMENTS ENCLOSED", "DRAFT(S)", "COMMERCIAL INVOICE", "PACKING LIST", "CERT OF ORIGIN", "TRUCK CONSIGNMENT NOTE"],
  "encloseddoc2": ["NOS", "2 ORIGINALS+ 0 COPY", "0 ORIGINAL+ 10 COPIES", "0 ORIGINAL+ 10 COPIES", "0 ORIGINAL+ 10 COPIES", "0 ORIGINAL+ 8 COPIES"]
}
